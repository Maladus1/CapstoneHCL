...
public class SendEmail{
	public void sendMail(String email, String user) {
	      ...
	      final String username = "d0ef9111c8b183";//username generated by Mailtrap
	      final String password = "8122522163c79c";//password generated by Mailtrap
	    ...
	    message.setText("Hi "+ user +  "! Your account has been registerd!");
